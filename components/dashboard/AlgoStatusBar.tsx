...
function AlgoCard({
  ...
  return (
    ...
    >
      {/* Header */}
      <div className="px-4 pt-4 pb-3.5 flex items-start gap-2.5">
        ...
        <div className="min-w-0 flex-1">
          ...
          <div className="text-dim text-[9px] mt-1.5 tracking-[0.06em] uppercase truncate">
      ...
      {/* Footer */}
      <div className="px-4 pb-3.5 pt-0 flex items-center justify-between text-[9px] tracking-[0.06em]">
...
function Stat({
  ...
  return (
    <div>
      ...
      <div className={`text-[19px] font-semibold leading-tight mt-2 ${cls}`}>
        {value}
      </div>
    </div>
  );
